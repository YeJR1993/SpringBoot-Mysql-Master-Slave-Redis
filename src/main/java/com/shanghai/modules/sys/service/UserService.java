...
public interface UserService {
	 ...
	 * @throws IOException
	 */
	public List<User> queryByLoginNameAndPhoneNo(int pageNo, int pageSize, String userName, String phoneNo) throws IOException;
